...
> 自动生成自组件库文档，细节请用 `antd-cli components get button` / `antd-cli demos get button/<id>`。
...
```bash
antd-cli components get button --json
antd-cli demos list button --json
antd-cli demos get button/<demo-id> --json
```
